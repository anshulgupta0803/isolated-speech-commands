...
ngram-count -lm $tgtdir/2gram.kn01.gz -wbdiscount1 -gt1min 0 -wbdiscount2 -gt2min 1 -order 2 -text $tgtdir/train.txt -vocab $tgtdir/vocab -unk -sort -map-unk "$oov_symbol"
...
ngram-count -lm $tgtdir/2gram.kn02.gz -wbdiscount1 -gt1min 0 -wbdiscount2 -gt2min 2 -order 2 -text $tgtdir/train.txt -vocab $tgtdir/vocab -unk -sort -map-unk "$oov_symbol"
